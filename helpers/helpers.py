...
def load_test_input(endpoint: str, test_name: str) -> dict:
    # Load request input data for a specific endpoint test case.
...
def load_test_expected(endpoint: str, test_name: str) -> dict:
    # Load expected response data for a specific endpoint test case.
...
def assert_json_response(response, expected_status_code, expected_body):
    # Validate status code, JSON content type, and exact response body.
