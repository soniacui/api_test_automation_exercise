...
# Loads endpoint URL and payload from the input JSON file for a given test case
...
# Loads expected response data for a specific endpoint test case.
...
# Verifies the response status code, content type, and JSON body against expected values.
